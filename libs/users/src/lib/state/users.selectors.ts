...
import { USERS_FEATURE_KEY, UserPartialState, UserState } from './users.reducer';

// Lookup the 'Users' feature state managed by NgRx
// export const getUsersState = createFeatureSelector<UserPartialState, UserState>(USERS_FEATURE_KEY);
